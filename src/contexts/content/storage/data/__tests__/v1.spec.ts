...
import V1DataManager, { type V1DataLayout } from "@content/storage/data/v1/index";
...
describe("v1 data", () => {
    it("should tell if a value exists", async () => {
        const mng = new V1DataManager(loadStorageDriver(testData.storage));
    ...
    it("should be able to save data", async () => {
        const mng = new V1DataManager(loadStorageDriver({}));
